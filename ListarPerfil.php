...
document.write('<font size=2 color="white">'+day + '</font>' +'<font size=2 color="white">' + myweekday + '</font>' +'<font  color="white">'+ month + year + ' - </font>' + '<font size=2 color="white">' + timeValue + '</font></p>')
