...
body a:link{text-decoration:none;}
 ...
 .contatos{float:left; position:relative; width:870px;  margin-top:34px; margin-left:-20px;
 ...
 #contador{background-image:url("././BACKGROUNDS/contador.png");background-repeat:no-repeat;  width:130px; height:30px;}
...
<br/><br/>
<!--<legend>-->
<div style="background-color:BLACK; border-radius:12px; width:100%; height:60px; "><p STYLE="width:100%; font-size:140%; color:#ad0a0a; padding-top:16px; padding-left:10px;">TODOS SEUS PARCEIROS</p></div>
...
echo'<button type="button" name="voltar" value="Voltar" style="width:100%;">Voltar</button>';
echo '<h3 style="color:white;">Contatos de'.' '.ucwords(str_replace("_"," ",$perfil));
echo'</h3>';
...
$limiteContato=@mysql_query("SELECT * FROM ".strtolower($perfil)." ;",$conexao);
...
if($linhasContato>1){
    ...
    echo'<div class="contatos"><br/><a name="contatos"><b>MEUS PARCEIROS</b></a></div>
    <div id="contador" style="float:left; position:relative; margin-top:45px; margin-left:118px;
    padding:6px 0px 0px 16px;">
    <font color="white"  >'.$linhasContatoMenos.' parceiros</font></div>
