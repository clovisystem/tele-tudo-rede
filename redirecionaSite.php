...
<main  class="container container-fluid  col-xs-12 " > 
<BR/><BR/>
<div style="background-color:BLACK; border-radius:12px; width:100%; height:60px; "><p STYLE="width:100%; font-size:20px; color:#ad0a0a; padding-top:16px; padding-left:10px;">PESQUISANDO...</p></div>
...
if($_POST["CEP"]){
    ...
    if ($CEP==null or $PESQ==null){
        echo'<b>Informe os dados corretamente!</b><script>history.go(-1);</script>';
    }
    else{

        echo'<script>location.href="http://www.tele-tudo.com/produtos?id='.$id.'&CEP='.$CEP.'&PESQ='.$PESQ.'&Tpe=0";</script>';
    }
}
