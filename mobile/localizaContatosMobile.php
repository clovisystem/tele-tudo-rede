...
<?php
 ...
 if($tipo=="usuario"){
	...
	?>
		<div id="radio" style="color:white; font-weight:600px; font-size:20px; background:#ad0a0a; border-radius:12px; width:100%; height:60px; padding-left:10px;">
	...
	<p style="color:white;"><b>INFORME O NOME DO FORNECEDOR(A)/USUÁRIO(A):</b></p><br/>
...
<!-- | <input type="button" name="voltar1" value="Voltar" onclick="history.go(-1)"/>-->
	...
	<?php
	 ...
	 echo '<div class="botao"><a href=localizaContatos2mobile.php?nome='.@mysql_result($exibeContato,$j,tituloPerfil).'&login='.$login.'&tipo='.$tipo.'>';
